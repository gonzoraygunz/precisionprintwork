      ...
      <div className="max-w-5xl mx-auto px-4 py-20">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 mb-16">
          {projects.map((project) => (
            <div key={project.src} className="rounded-xl overflow-hidden border border-slate-700 bg-slate-800 hover:border-cyan-700 transition-colors">
        ...
        <div className="circuit-bg bg-slate-800 border border-slate-700 rounded-2xl p-8 text-center">
